...
import static com.snipe.apmt.common.Status.FAILURE;

import static com.snipe.apmt.common.Status.SUCCESS;
import static com.snipe.apmt.exception.APMTRestException.INTERNAL_ERROR_CODE;
...
public class GenericRes<T> {
	...
	public GenericRes(Throwable exception) {
		...
		if (exception instanceof APMTRestException) {
			APMTRestException ae = (APMTRestException) exception;
			status = FAILURE;
